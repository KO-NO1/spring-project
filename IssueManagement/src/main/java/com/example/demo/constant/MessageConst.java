...
public class MessageConst {
	...
	/** 課題管理一覧画面：既に登録済み*/
	public static final String ALREADY_COMPLETED = "alreadyCompleted";

	/** 課題管理一覧情報編集画面：存在しない管理番号 */
	public static final String NON_EXISTED_ID = "nonExistedId";

	/** 課題管理一覧情報編集画面：更新成功 */
	public static final String UPDATE_SUCCEED = "Edit.updateSucceed";

	/** 課題管理一覧情報編集画面：更新失敗 */
	public static final String UPDATE_FAILED = "Edit.updateFailed";

	/** 課題管理一覧画面：課題管理削除完了 */
	public static final String DELETE_SUCCEED = "List.deleteSucceed";
